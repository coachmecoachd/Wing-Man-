                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input title="Date and Time" type="datetime-local" value={dateTime} onChange={e => setDateTime(e.target.value)} className={inputClasses} />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <select title="Who are you going with?" value={selectedProfileId} onChange={e => {
        ...
        <div className="bg-secondary p-6 rounded-2xl shadow-lg flex flex-col sm:flex-row items-start gap-6 border border-gray-200 hover:border-accent/30 transition-colors group">
            ...
            <div className="flex-grow w-full">
                <div className="flex justify-between items-start">
                    ...
                    <button title="Delete Date" onClick={() => onDelete(date.id)} className="text-gray-400 hover:text-red-500 p-2 rounded-full hover:bg-red-500/10 transition-colors opacity-0 group-hover:opacity-100">
                        <Trash2 size={20} />
                    </button>
                </div>
