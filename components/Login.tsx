...
=======
  const [registry, setRegistry] = useLocalStorage<UserRegistry>('bruh-user-registry', {});
>>>>>>> 7a3b66c (Update README with correct repo info)
...
=======
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-ocean/10 rounded-full blur-[100px]"></div>
>>>>>>> 7a3b66c (Update README with correct repo info)
      </div>
...
=======
             <div className="inline-block p-4 rounded-full bg-secondary mb-4 shadow-lg shadow-accent/10 border border-gray-200">
                <HeartHandshake size={48} className="text-accent" />
             </div>
            <h1 className="text-7xl font-black text-text-primary mb-2 tracking-tighter">
              BRUH<span className="text-accent">!</span>
            </h1>
            <p className="text-xl text-text-secondary">Your AI Wingman.</p>
        </div>
        
        <div className="bg-secondary/80 backdrop-blur-xl border border-gray-200 p-8 rounded-2xl shadow-2xl">
          <div className="flex justify-center mb-6 border-b border-gray-200 pb-4">
             <button 
                onClick={() => { setIsRegistering(false); setError(''); }}
                className={`px-6 py-2 text-sm font-bold transition-colors ${!isRegistering ? 'text-text-primary border-b-2 border-accent' : 'text-text-secondary hover:text-text-primary'}`}
>>>>>>> 7a3b66c (Update README with correct repo info)
             >
                 Sign In
             </button>
...
=======
              <label className="block text-xs font-medium text-text-secondary uppercase tracking-wider mb-1 ml-1">Username</label>
>>>>>>> 7a3b66c (Update README with correct repo info)
              <input
                type="text"
...
=======
                className="w-full bg-tertiary border border-gray-200 rounded-xl py-3 px-4 text-text-primary focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all placeholder-text-secondary"
>>>>>>> 7a3b66c (Update README with correct repo info)
...
=======
              <label className="block text-xs font-medium text-text-secondary uppercase tracking-wider mb-1 ml-1">Password</label>
>>>>>>> 7a3b66c (Update README with correct repo info)
              <input
                type="password"
...
=======
                <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-500 text-sm flex items-center gap-2 animate-fade-in">
>>>>>>> 7a3b66c (Update README with correct repo info)
                    <AlertCircle size={16} />
                    {error}
                </div>
...
=======
              className="w-full bg-accent hover:bg-accent-hover text-white font-bold py-3.5 rounded-xl shadow-lg shadow-accent/25 transform transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center"
>>>>>>> 7a3b66c (Update README with correct repo info)
            >
              {isLoading ? (
...
=======
            className="w-full bg-tertiary text-text-primary font-bold py-3.5 rounded-xl hover:bg-gray-200 transition-colors flex items-center justify-center gap-3 border border-gray-200"
>>>>>>> 7a3b66c (Update README with correct repo info)
          >
