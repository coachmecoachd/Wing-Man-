        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
             <div className="flex flex-col items-center space-y-4 flex-shrink-0">
                <div className="relative group cursor-pointer w-40 h-40" onClick={() => fileInputRef.current?.click()}>
                    ...
                    <input type="file" ref={fileInputRef} onChange={handleFileUpload} accept="image/*" className="hidden" title="Upload avatar image" />
                </div>
        ...
        return (
            <div className="max-w-4xl mx-auto pb-10">
                <div className="flex items-center gap-4 mb-8">
                    <button onClick={() => setIsEditing(false)} className="p-3 rounded-full hover:bg-tertiary transition-colors text-text-secondary" title="Back">
                        <ArrowLeft size={24} />
                    </button>
        ...
        <div className="space-y-8 animate-fade-in max-w-5xl mx-auto">
            ...
            <div className="bg-secondary p-8 md:p-10 rounded-[2rem] shadow-2xl border border-gray-200 flex flex-col md:flex-row gap-10">
                ...
                <div className="md:border-l border-gray-200 md:pl-10 flex-grow space-y-8">
                     <div className="relative bg-tertiary/30 p-6 rounded-2xl border border-gray-200/50">
...
const ProfileManager: React.FC<{
  ...
  if (isCreating) {
      ...
      return (
        <div className="max-w-4xl mx-auto pb-10">
            <div className="flex items-center gap-4 mb-8">
                <button onClick={() => setIsCreating(false)} className="p-3 rounded-full hover:bg-tertiary transition-colors text-text-secondary" title="Back">
                    <ArrowLeft size={24} />
                </button>
